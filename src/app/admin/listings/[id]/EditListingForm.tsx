...
import { ChevronDown, Loader2, X, Plus, GripVertical, Upload, Trash2, Eye } from "lucide-react";
...
function SectionHeader({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 pt-2">
      <h3 className="text-xs font-medium text-neutral-400 dark:text-neutral-500 shrink-0">{children}</h3>
...
// --- PhotoManager (mirrors ReviewForm's photo grid) ---
