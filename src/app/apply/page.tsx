...
export default function ApplyPage() {
  ...
  const inputStyle = "w-full px-4 py-2.5 text-sm border border-black/15 rounded-lg bg-white focus:outline-none focus:border-black/40 transition-colors";
        ...
        <div className="text-center mb-8">
          ...
          {submitted ? (
            <>
              ...
              <p className="text-sm text-black/50" style={fontCalibr}>
