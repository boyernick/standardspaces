...
function inferSubcategories(
  ...
  const keywordMap: Record<string, Record<string, string[]>> = {
    dining: {
      ...
      "Seafood": ["seafood", "oyster", "lobster", "crab"],
      "Tasting menu": ["tasting menu", "degustation", "multi-course"],
      ...
      "Korean": ["korean", "kbbq", "korean bbq", "bibimbap", "bulgogi"],
      ...
      "Mexican": ["mexican", "taqueria", "mole"],
      "Peruvian": ["peruvian", "nikkei", "ceviche", "pisco"],
      "Caribbean": ["caribbean", "cuban", "jamaican", "haitian", "puerto rican"],
      "Thai": ["thai", "pad thai"],
      ...
      "Contemporary American": ["contemporary american", "modern american"],
      "New American": ["new american"],
      "Southern": ["southern", "cajun", "creole", "lowcountry"],
      "BBQ": ["barbecue", "bbq", "barbeque", "smokehouse", "smoked"],
      "Pizza": ["pizza", "pizzeria", "neapolitan", "wood-fired"],
      "Burger": ["burger", "smashburger", "cheeseburger"],
      "Sandwich shop": ["sandwich shop", "sandwiches", "deli", "sub shop", "hoagie"],
      "Vegan": ["vegan", "plant-based", "vegetarian"],
      "Chef's table": ["chef's table", "chefs table"],
    },
    drinks: {
      "Cocktail bar": ["cocktail", "mixology", "craft cocktail"],
      "Wine bar": ["wine bar", "wine list", "sommelier"],
      "Natural wine bar": ["natural wine", "low-intervention wine", "biodynamic wine"],
      "Speakeasy": ["speakeasy", "hidden bar", "secret bar", "password"],
      "Hotel bar": ["hotel bar", "lobby bar"],
      "Nightclub": ["nightclub", "dance floor", "nightlife"],
      "Lounge": ["lounge"],
      "Rooftop bar": ["rooftop bar", "rooftop", "sky bar"],
      "Beach bar": ["beach bar", "beachfront bar", "tiki beach"],
      "Dive bar": ["dive bar", "neighborhood bar", "local bar"],
      "Tiki bar": ["tiki", "tropical cocktail"],
      "Mezcal bar": ["mezcal", "agave"],
      "Sake bar": ["sake bar", "sake"],
      "Whiskey bar": ["whiskey bar", "whisky bar", "scotch bar", "bourbon bar"],
    ...
    coffee: {
      ...
      "Matcha bar": ["matcha", "ceremonial matcha", "matcha bar"],
      "Tea house": ["tea house", "tea room", "loose leaf"],
      "Bakery café": ["bakery café", "bakery cafe", "coffee and pastry", "bakery", "boulangerie", "viennoiserie", "croissant", "sourdough"],
      ...
      "Juice bar": ["juice bar", "cold pressed", "fresh juice"],
      "Smoothie bar": ["smoothie bar", "smoothies"],
      "Açaí bar": ["açaí", "acai", "acai bowl"],
      "Breakfast spot": ["breakfast spot", "breakfast cafe", "all day breakfast"],
    },
    wellness: {
      "Gym": ["gym", "fitness center"],
      "Recovery": ["recovery studio", "recovery lounge"],
      "Spa": ["spa", "day spa"],
      "Yoga": ["yoga", "hot yoga", "vinyasa", "ashtanga"],
      "Pilates": ["pilates", "reformer"],
      "Barbershop": ["barbershop", "barber"],
      "Hair salon": ["hair salon", "beauty salon", "blow dry bar"],
      ...
      "Brow & lash": ["brow bar", "lash bar", "lash extensions", "microblading"],
      "Acupuncture": ["acupuncture"],
      "Chiropractic": ["chiropractic", "chiropractor"],
      "Physical therapy": ["physical therapy", "physiotherapy"],
      "Cycling studio": ["cycling studio", "spin studio", "soulcycle"],
      "Dance studio": ["dance studio", "dance class"],
      "Climbing gym": ["climbing", "bouldering", "rock climbing"],
      "Tennis club": ["tennis", "tennis club"],
      "Padel club": ["padel", "padel club"],
      "Golf": ["golf", "golf club", "driving range", "top golf"],
    },
    shopping: {
      "Boutique": ["boutique", "curated shop", "fashion", "clothing", "apparel"],
      ...
      "Florist": ["florist", "flower shop", "floral studio"],
      "Stationery": ["stationery", "stationer", "paper goods"],
    ...
    members: {
      ...
      "Business club": ["business club", "networking club"],
    ...
    hotels: {
      ...
      "Resort": ["resort"],
      "Beach resort": ["beach resort", "beachfront resort", "oceanfront resort"],
      ...
      "Glamping": ["glamping", "luxury camping", "safari tent"],
    },
  };
...
function inferVibes(
  ...
  const vibeKeywords: Record<string, string[]> = {
    ...
    "Business dinner": ["business dinner", "corporate", "private dining room", "executive"],
    "Power lunch": ["power lunch", "business lunch", "deal-making"],
    "Brunch": ["brunch", "bottomless brunch", "sunday brunch", "weekend brunch"],
    "Late night": ["late night", "late-night", "open late", "after midnight", "open until 2", "open until 3", "open until 4", "open until 5", "after hours"],
    "Sunday funday": ["sunday funday", "sunday session"],
    ...
    "Family friendly": ["family friendly", "family-friendly", "kid friendly", "kid-friendly", "kids menu"],
    "Pet friendly": ["pet friendly", "pet-friendly", "dog friendly", "dog-friendly"],
    // Setting
    "Outdoor": ["outdoor", "patio", "terrace", "al fresco", "sidewalk"],
    ...
    "Garden": ["garden", "garden seating", "courtyard"],
    "Intimate": ["intimate", "cozy", "tucked away"],
    ...
    "Iconic": ["iconic", "legendary", "landmark", "institution"],
    "Tourist must-do": ["must visit", "must-visit", "famous", "world-renowned"],
    "Romantic": ["romantic", "candlelight", "valentine"],
    "Sceney": ["see and be seen", "celebrity", "vip", "bottle service", "velvet rope", "exclusive", "people watching"],
  };
  ...
  if (category === "wellness") {
    if (subs.includes("Spa") || subs.includes("Recovery") || subs.includes("Cold plunge") || subs.includes("Sauna")) {
      if (!matched.includes("Intimate")) matched.push("Intimate");
    }
  }
  ...
  if (g) {
    ...
    if (a.outdoorSeating) add("Outdoor");
